    ...
    <div className="container-custom py-16">
      <div className="max-w-md mx-auto card p-8">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <input className="input w-full" type="text" placeholder="Full name" value={name} onChange={e=>setName(e.target.value)} required />
        ...
        <div className="mt-4 space-y-3">
          ...
          <button className="btn-outline w-full" onClick={()=>router.push('/login')}>Already have an account? Sign in</button>
        </div>
      </div>
    </div>
  );
