      ...
      <div className="max-w-md mx-auto card p-8">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
          ...
          <div className="text-sm text-yellow-800 space-y-1">
            <div>1. Get the user's Firebase UID from Firebase Console → Authentication → Users</div>
            <div>2. Use the admin promotion key from your environment variables</div>
            <div>3. This will give the user admin access to the dashboard</div>
          </div>
        </div>
